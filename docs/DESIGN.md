...
1. settlement-only Ethereum orchestration that composes the existing primitives without changing the user-held parents;
2. a reproducible local environment and evidence summaries after both Ethereum workflows are deterministic;
