...
| [Zelle Executive Briefing](https://github.com/johnwhitton/digital-banking/blob/main/docs/reference/zelle-digital-asset-settlement-executive-brief.pdf)             | v1.0.6, 27-page executive architecture brief aligned with the local dual-chain Ethereum and Solana implementation.                                                                                                     | Executives, hiring managers, principal engineers, product, risk, and architecture leaders. | `15-18 mins`                       |
...
The executive PDF states an 18-minute estimate. The v1.0.5 release manifest records 49,762 extracted words for the detailed architecture and a guided reading path, so the table distinguishes a guided route from a complete technical read. Volume I v1.0.5 remains the detailed Ethereum-aligned reference architecture. The Executive Brief v1.0.6 is the concise Solana/dual-chain alignment anchored to executable implementation evidence `173ebcbb002cacad479c7ced4361106e7c6f21dc`. Volume II v1.1.0 and Volume III v1.0.0 are unchanged contextual companions, not production certification or runnable releases. Publication snapshots may lag the live repository; current source, tests, OpenAPI, accepted [ADRs](docs/adr/README.md), [the engineering design](docs/DESIGN.md), and [the implementation plan](docs/IMPLEMENTATION.md) govern current implementation claims. All four PDFs are immutable contextual reference inputs, and their provenance and metadata remain in the [reference index](docs/reference/README.md).
